...
| Detail | `cms/*_detail.html` (accession, accession_row, drawerregister, fieldslip, locality, place, preparation, reference, storage) | Cards and summary grids consistently use `w3-card`, `w3-white`, `w3-padding`, and responsive columns via `w3-row-padding`.【F:app/cms/templates/cms/storage_detail.html†L7-L83】 | History tables and related lists already follow W3 table patterns; no custom CSS hooks remain aside from default typography classes.【F:app/cms/templates/cms/storage_detail.html†L84-L170】 | Focus on tightening semantic landmarks (`<section>`, `<aside>`) and ensure repeated history tables become an include shared by detail views. |
| Detail + Sub-list | `cms/locality_detail.html`, `cms/storage_detail.html` | Combine W3 cards for the primary object with paginated tables for related data.【F:app/cms/templates/cms/storage_detail.html†L38-L108】 | Manual pagination components mirror the helper used in list templates and rely solely on W3 bar/button classes.【F:app/cms/templates/cms/storage_detail.html†L108-L147】 | Align pagination markup with a single include referenced by both list and detail pages to reduce drift. |
