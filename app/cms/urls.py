...
urlpatterns = [
    ...
    path('accession-row/<int:accession_row_id>/add-specimen/', NatureOfSpecimenCreateView.as_view(), name='natureofspecimen-create'),
