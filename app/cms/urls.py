...
from cms.views import (
    ...
    AccessionElementMergeView,
    accession_element_delete,
...
urlpatterns = [
    ...
    path(
        "accessionrows/<int:accession_row_id>/merge-elements/",
        AccessionElementMergeView.as_view(),
        name="accession_merge_elements",
    ),
    path(
        "accession-elements/<int:pk>/delete/",
        accession_element_delete,
        name="accession_element_delete",
    ),
