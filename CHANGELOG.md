...
- Add QR codes to accession row print cards (big and small) so printouts link back to the specimen detail page, generated on
  the client and paired with in-page print controls.
