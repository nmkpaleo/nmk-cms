...
- Document the Accession Reference merge flow, including field-selection defaults, same-accession safeguards, and admin/user guidance.
...
- Document specimen list page classification routing, queue operations, and rollback guidance.
- Add operational runbook steps for running specimen list page classification jobs in PythonAnywhere and Docker environments.
...
- Add delete actions for accession row Elements so collection managers can remove Nature of Specimen records with confirmation.
