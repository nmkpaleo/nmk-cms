...
- Document accession row element merge/delete flows for collection managers, including the on-page merge panel, field-selection confirmation, and guarded delete action (T3).
